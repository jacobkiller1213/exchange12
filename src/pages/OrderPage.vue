...
const updateStatusContent = () => {
    ...
    const telegram_support = "https://t.me/WXBCyber_com"; // Replace with actual support URL
                ...
                <div class="layout">
                    <div class="layout__info">
                        ...
                        <div class="layout__contact">
                            ...
                            <div class="links"> <a class="links__item" href="tg://resolve?domain=WXBCyber_com"> <img src="/xgram/images/icons/telegram.svg" width="17" alt="Наш Telegram-канал"> </a></div>
                        </div>
                    </div>
