      ...
      <div class="about__block">
        <div class="about__desc">
          ...
          <div class="about__text">
             — платформа для обмена криптовалюты, ориентированная на работу
      ...
      <div class="about__block">
        ...
        <div class="about__desc">
          ...
          <div class="about__text">
            ...
            полную анонимность операций.  сочетает преимущества обеих
      ...
      <div class="about__block">
        <div class="about__desc">
          ...
          <div class="about__text">
            ...
            безопасностью и ликвидностью — с  вы получаете лучшее от обоих
      ...
      <div class="features__items">
        <div class="features__item">
          ...
          <div class="section__text features__text">
            Все переводы на платформе  защищены посредством
        ...
        <div class="features__item">
          ...
          <div class="section__text features__text">
            ...
            использованию принципов децентрализации.  гарантирует, что
        ...
        <div class="features__item">
          ...
          <div class="section__text features__text">
            Платформа  объединяет собственную ликвидность и ликвидность
            CEX, что позволяет обрабатывать большие объёмы транзакций без
            задержек. Независимо от выбранной криптовалюты,  гарантирует
      ...
      <section class="steps section" id="how_it_works">
        <div class="section__top">
          ...
          <div class="section__promo-text">
            Для обмена криптовалют онлайн на  достаточно следовать
          ...
          <li class="steps__item">
            <div class="steps__desc">
              ...
              <div class="section__text steps__text">
                Выберите криптовалюты, которые хотите обменять. На
          ...
          <li class="steps__item">
            ...
            <div class="steps__desc">
              ...
              <div class="section__text steps__text">
                ...
                активов на указанный адрес. Все комиссии на  прозрачны, без
          ...
          <li class="steps__item">
            <div class="steps__desc">
              ...
              <div class="section__text steps__text">
                ...
                Благодаря скорости и надежности операций  выбирают
          ...
          <div class="choose__wrapper">
            <div class="choose__desc">
              ...
              <div class="section__promo-text choose__promo-text">
                <p>
                  С  можно проводить обмены на любом устройстве — от
                ...
                <p>
                  ...
                  работает в мобильной версии и на десктопе. Это делает
      ...
      <div class="questions__items">
        <div class="questions__item tabs show">
          ...
          <div class="questions__text tabs__content">
             работает только с лучшими курсами на обмен, поэтому ваша
        ...
        <div class="questions__item tabs">
          ...
          <div class="questions__text tabs__content">
            Комиссия на платформе  минимальна. Она зависит от выбранной
        ...
        <div class="questions__item tabs">
          ...
          <div class="questions__text tabs__content">
            На  поддерживается огромный выбор цифровых активов: биткойн,
        ...
        <div class="questions__item tabs">
          ...
          <div class="questions__text tabs__content">
             использует продвинутые методы криптографии, гарантируя защиту
